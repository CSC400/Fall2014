  ...
  //This script executes only when all the error variables are empty, a.k.a validation is OK.  
	...
	if($errinputFirst=="" and $errinputLast=="" and $errinputAddress=="" and $errinputCity=="" and $errinputState=="" 
        ...
        $arr=array('Purpose' => $inputClassroomStyle, 'podiumType' => $inputInstructPodium, 'projection' => $inputInstructPodium,
                   ...
                   'Room Length' => $inputClassLength, 'Room Width' => $inputClassWidth, 'Room Height' => $inputClassHeight, 'budget' => $inputBudget,
                   'inputCompDate' => $inputCompDate, 'Summary' => $inputSummary);
...
<body>
    ...
    <div class="row"><h3></h3></div>
		<form id="myform" class="form-horizontal" method="POST" action="submitRfp2.php">
	<fieldset>
	<legend>Contact Information</legend>
		...
		<!-- TODO: need to put span element for errors -->
		<div class="form-group">
			<label for="inputMultimedia" class="control-label col-xs-2">Multimedia</label>
			<div class="col-xs-4">
				<label class="checkbox-inline">
					<input type="checkbox" name="inputMultimedia[]" value="vcr" checked> VCR
				</label>
				<label class="checkbox-inline">
					<input type="checkbox" name="inputMultimedia[]" value="dvd"> DVD 
				</label>
				<label class="checkbox-inline">
					<input type="checkbox" name="inputMultimedia[]" value="bluray"> BluRay
				</label>
			</div>
		</div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-4">
              <label class="radio-inline">
                <input type="radio" name="inputAudioQuality"  value="yes" checked> Yes
              </label>
              <label class="radio-inline">
                <input type="radio" name="inputAudioQuality" value="no"> No
              </label>
            </div>       
        </div>
